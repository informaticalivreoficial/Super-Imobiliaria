...
class Pager {
     ...
     */
    public function getPaginator($Tipo = null) {
        $termo = (string) $Tipo;
        if($termo == 'admin'):
    ...
    private function getSyntax() {
        ...
        if ($this->Rows > $this->Limit):
            ...
            $this->Paginator .= "<li><a title=\"{$this->First}\" href=\"{$this->Link}1\"><span aria-hidden=\"true\">«</span></a></li>";                

            //$this->Paginator .= "<ul class=\"\">";
            //$this->Paginator .= "<li class=\"prev disabled\"><a title=\"{$this->First}\" href=\"{$this->Link}1\">← {$this->First}</a></li>";
           ...
           // $this->Paginator .= "<li class=\"next\"><a title=\"{$this->Last}\" href=\"{$this->Link}{$Paginas}\">{$this->Last} →</a></li>";
            //$this->Paginator .= "</ul>";
            
            //$this->Paginator .= "<div class=\"next-post\">";
            $this->Paginator .= "<li><a title=\"{$this->Last}\" href=\"{$this->Link}{$Paginas}\"><span aria-hidden=\"true\">»</span></a></li>";
            //$this->Paginator .= "</ul>";
            
            
            // ADMIN
            //$this->PaginatorAdmin = "<div>";
            //$this->PaginatorAdmin .= "<a title=\"{$this->First}\" href=\"{$this->Link}1\"><span class=\"fa fa-angle-double-left\"></span> {$this->First}</a>";
            //$this->PaginatorAdmin .= "</div>";
        
    

            $this->PaginatorAdmin = "<ul class=\"pagination pagination-lg\">";
            $this->PaginatorAdmin .= "<li><a title=\"{$this->First}\" href=\"{$this->Link}1\">« </a></li>";

            for ($iPag = $this->Page - $MaxLinks; $iPag <= $this->Page - 1; $iPag ++):
                if ($iPag >= 1):
                    $this->PaginatorAdmin .= "<li><a title=\"Página {$iPag}\" href=\"{$this->Link}{$iPag}\">{$iPag}</a></li>";
                endif;
            endfor;

            $this->PaginatorAdmin .= "<li class=\"active\"><a>{$this->Page}</a></li>";

            for ($dPag = $this->Page + 1; $dPag <= $this->Page + $MaxLinks; $dPag ++):
                if ($dPag <= $Paginas):
                    $this->PaginatorAdmin .= "<li><a class=\"inactive\" title=\"Página {$dPag}\" href=\"{$this->Link}{$dPag}\">{$dPag}</a></li>";
                endif;
            endfor;

            $this->PaginatorAdmin .= "<li><a title=\"{$this->Last}\" href=\"{$this->Link}{$Paginas}\"> »</a></li>";
            $this->PaginatorAdmin .= "</ul>";
            
            //$this->PaginatorAdmin .= "<div class=\"next-post\">";
            //$this->PaginatorAdmin .= "</div>";
        endif;
    }
