...
<div class="page-heading">
    <div class="row">
        ...
        <div class="col-sm-6">
            <a href="painel.php?exe=clientes/time" title="Voltar e listar Usuários" class="btn btn-primary btn-lg" style="float:right;"><i class="fa fa-mail-reply"></i> Voltar e listar Usuários</a>	
        </div>
    </div>
</div>
                                                ...
                                                <div class="col-md-5 form-group"> 
                                                    <div class="row">                               
                                                        <div class="col-md-12 form-group">
                                                            ...
                                                            <input type="text" class="form-control input-lg" name="nome" value="<?php if (!empty($user['nome'])) echo $user['nome']; ?>" />
                                                        </div>                                    
                                                    </div>                               
                                                    <div class="row">
                                                        <div class="col-md-12 form-group">
                                                            <label><strong>E-mail</strong></label>
                                                            <input type="text" class="form-control input-lg" name="email" value="<?php if (!empty($user['email'])) echo $user['email']; ?>" />
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12 form-group">
                                                            ...
                                                            <input type="text" class="form-control input-lg" name="facebook" value="<?php if (!empty($user['facebook'])) echo $user['facebook']; ?>" />
                                                        </div>
                                                    </div>
...
<?php endif; ?>                                        
                                                        ...
                                                        <div class="col-md-6 form-group">
                                                            ...
                                                            <input class="form-control form-control-inline input-lg default-date-picker" size="16" type="text" name="nasc" value="<?php if (!empty($user['nasc'])): echo $user['nasc'];
                                            ...
                                            <div class="row"> 
                                                <div class="col-md-5 form-group">
                                                    ...
                                                    <input type="text" class="form-control input-lg" name="bairro" value="<?php if (!empty($user['bairro'])) echo $user['bairro']; ?>" />
                                                </div>                        
                                                <div class="col-md-2 form-group">
                                                    <label><strong>Número</strong></label>
                                                    <input type="text" class="form-control input-lg" name="num" value="<?php if (!empty($user['num'])) echo $user['num']; ?>" />
                                                </div>
                                                <div class="col-md-2 form-group">
                                                    <label><strong>Cep</strong></label>
                                                    <input type="text" class="form-control input-lg" data-mask="99.999-999" name="cep" value="<?php if (!empty($user['cep'])) echo $user['cep']; ?>" />
                                                </div>
                                                <div class="col-md-3 form-group">
                                            ...
                                            <div class="row">
                                                <div class="col-md-3 form-group">
                                                    ...
                                                    <input type="text" class="form-control input-lg" data-mask="(99) 9999-9999" name="telefone1" value="<?php if (!empty($user['telefone1'])) echo $user['telefone1']; ?>" />
                                                </div>
                                                <div class="col-md-3 form-group">
                                                    <label><strong>Telefone móvel</strong></label>
                                                    <input type="text" class="form-control input-lg" data-mask="(99) 99999-9999" name="telefone2" value="<?php if (!empty($user['telefone2'])) echo $user['telefone2']; ?>" />
                                                </div>
                                                <div class="col-md-3 form-group">
                                                    <label><strong>WhatsApp</strong></label>
                                                    <input type="text" class="form-control input-lg" data-mask="(99) 99999-9999" name="whatsapp" value="<?php if (!empty($user['whatsapp'])) echo $user['whatsapp']; ?>" />
                                                </div>
                                                <div class="col-md-3 form-group">
                                                    <label><strong>Skype</strong></label>
                                                    <input type="text" class="form-control input-lg" name="skype" value="<?php if (!empty($user['skype'])) echo $user['skype']; ?>" />
                                                </div>                            
                                            </div>
