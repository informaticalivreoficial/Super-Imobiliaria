...
<div class="row">
    <div class="col-sm-6">
        <h3>Atualizar Cliente</strong></h3>
    </div>
    <div class="col-sm-6">
...
<?php
    ...
    if($post && $post['sendFormPost']):    
        ...
        $ReadCliente->ExeRead("usuario", "WHERE tipo = '2' AND id = :postid", "postid={$postId}");
        if ($ReadCliente->getResult()):
            $post = $ReadCliente->getResult()[0]; 
            $post['nasc'] = date('d/m/Y', strtotime($post['nasc']));
                            ...
                            <div class="col-md-2 form-group" style="text-align: center;">
                                <div class="fileupload fileupload-new" data-provides="fileupload">
                                    <div class="fileupload-new thumbnail" style="width: 160px; height: 160px;">
                                        <?php 
                                            $read1 = new Read;
                                            $read1->ExeRead("usuario","WHERE id = :id","id={$postId}");
                                            if(!$read1->getResult()):
                            ...
                            <div class="col-md-10 form-group"> 
                                <div class="row">                               
                                    ...
                                    <div class="col-md-3 form-group">
                                        ...
                                        <button name="sendFormPost" type="submit" style="width:100%;" class="btn btn-success btn-lg" value="Atualizar">Atualizar</button>
                                    </div>
                                </div>                               
                                <div class="row">
                                    <div class="col-md-6 form-group">
                                    ...
                                    <div class="col-md-3 form-group">
                                        ...
                                        <input class="form-control form-control-inline input-lg default-date-picker" size="16" type="text" name="data" value="<?php if(!empty($post['data'])): echo $post['data']; else: echo date('d/m/Y'); endif;?>" disabled/>
                                    </div> 
                                </div>                            
