...
<?php
    ...
    $cadastra->ExeCreate('cat_clientes', $post);
    
    if (!$cadastra->getResult()):
        RMErro($cadastra->getError()[0], $cadastra->getError()[1]);
    else:
        header('Location: painel.php?exe=clientes/categoria-edit&create=true&catid=' . $cadastra->getResult().$getPage);
    endif;
...
<?php  
    ...
    $readCatPai = new Read;
    $readCatPai->ExeRead("cat_clientes", "WHERE id = :id", "id={$catid}");
