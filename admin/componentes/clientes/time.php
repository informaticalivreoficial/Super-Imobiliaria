...
<div class="page-heading">
    <div class="row">
        ...
        <div class="col-sm-6">
            <a href="painel.php?exe=clientes/time-create" title="Cadastrar Usuário" class="btn btn-default btn-lg" style="float:right;">Cadastrar Usuário</a>
        </div>
    </div>
</div>
            ...
            <section class="panel">
                ...
                <div class="panel-body">
                    <div class="adv-table">
                        ...
                        $Pager = new Pager('painel.php?exe=clientes/time&page=');
                                    ...
                                    foreach ($readUsuarios->getResult() as $usuario):
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a style="color: #333 !important;" class="btn btn-default btn-sm" title="Editar" href="painel.php?exe=clientes/time-edit&userid=<?= $id; ?>">
                                                    <i class="fa fa-pencil"></i>
                                                </a>

                                                <a title="Visualizar" href="painel.php?exe=clientes/time-perfil&userid=<?= $id; ?>" class="btn btn-info btn-sm">
