...
<div class="row">
    ...
    <div class="col-sm-6">
        <a href="painel.php?exe=artigos/categorias<?= $varPage;?>" title="Voltar e Listar categorias" class="btn btn-primary btn-lg right" style="float:right;"><i class="fa fa-mail-reply"></i> Voltar e Listar categorias</a>	
    </div>
</div>
</div>
...
<?php
    ...
    if (!$cadastra->getResult()):
        ...
        header('Location: painel.php?exe=artigos/categoria-edit&create=true&catid=' . $cadastra->getResult().$getPage);
    endif;
