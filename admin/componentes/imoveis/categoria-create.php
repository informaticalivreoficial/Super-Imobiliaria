...
<?php
    ...
    $cadastra->ExeCreate('cat_imoveis', $post);
    
    if (!$cadastra->getResult()):
        RMErro($cadastra->getError()[0], $cadastra->getError()[1]);
    else:
        header('Location: painel.php?exe=imoveis/categoria-edit&create=true&catid=' . $cadastra->getResult().$getPage);
    endif;
...
<?php  
    ...
    $readCatPai = new Read;
    $readCatPai->ExeRead("cat_imoveis", "WHERE id = :id", "id={$catid}");
