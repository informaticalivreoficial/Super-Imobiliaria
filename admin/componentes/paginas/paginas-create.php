...
<?php
    ...
    if ($cadastra->getResult()):
        if (!empty($_FILES['gallery_covers']['tmp_name'])):
            ...
            $sendGallery->gbSend($_FILES['gallery_covers'], $cadastra->getResult(), 'paginas/imagens');
        endif;

        header('Location: painel.php?exe=paginas/paginas-edit&artigos-create=true&postid=' . $cadastra->getResult());
    else:
